        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            else
            {
                ...
                //use two point and make path tangent to previous path end point
            ...
            // In frenet add evenly spaced point at 30m ahead of reference point
            ...
            //Fill up the rest of your planner after filling it with previous points, here we will always output 50 points
